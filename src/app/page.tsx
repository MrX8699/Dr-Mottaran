        ...
        <div className="relative z-20 px-6 py-12 w-full max-w-7xl mx-auto">
          <div className="max-w-3xl mx-auto text-center md:text-left">
            <p className="text-base md:text-lg text-white font-semibold tracking-wide uppercase mb-3">
              Benvenuto alla Cura Professionale
            </p>
            ...
            <p className="text-lg md:text-2xl text-white font-medium mb-3">
              Fisioterapista  Chinesiologo  Specialista in Medicina dello Sport
            </p>

            <p className="text-base md:text-lg text-white mb-6">Master in Riabilitazione Sportiva</p>

            <p className="text-base md:text-lg text-white/90 mb-8 leading-relaxed">
              Cura personalizzata per atleti e pazienti in riabilitazione. Analisi del movimento esperta e protocolli di
              recupero su misura per i tuoi obiettivi.
            </p>

            <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-start gap-3 md:gap-4">
              <a
              ...
              >
                {/* WhatsApp icon kept as SVG for crispness */}
