    ...
    <div className="min-h-screen">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href={`https://wa.me/393661459269?text=${encodeURIComponent(getWhatsAppMessage())}`} target="_blank" rel="noopener noreferrer">
                <Button className="bg-primary hover:bg-primary/90">{t('nav.book')}</Button>
              </a>
            </div>
            <button
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: 'url(/dr-mottaran.jpg)',
        ...
        <div className="relative z-10 text-left px-4 max-w-7xl mx-auto w-full">
          <div className="max-w-3xl">
            <p className="text-lg md:text-xl text-accent font-semibold tracking-wide uppercase mb-3 animate-fade-in">
              {t('hero.welcome')}
            </p>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight whitespace-pre-line">
              {t('hero.name')}
            </h1>
            <div className="text-xl md:text-2xl text-white/90 mb-4 space-y-2">
              <p className="font-medium">{t('hero.title')}</p>
              <p className="text-lg md:text-xl text-accent font-medium">{t('hero.subtitle')}</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-lg text-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105"
              >
